...
export default  function ChoroplethChart(props : ChoroplethProps) { 
  // export default async function ChoroplethChart(props : ChoroplethProps) { 
  ...
  //   WorldData = await d3.csv("https://raw.githubusercontent.com/holtzy/D3-graph-gallery/master/DATA/world_population.csv")
  //     // .then(res =>  {
  //     //   console.log(res);
  //     //   return res;
  //     // })
  //     // .catch(err => console.log("dummy data failed to load"))
  // }
      ...
      .then((res) =>{ 
        ...
        groups.append("text")
          ...
          .text( function(d:number, i: number){
            return  `${res.features[i].properties.name} has ${res.features[i].properties.beeCount} bees`;
          })
